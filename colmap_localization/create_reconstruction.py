...
os.system(f'{colmap_path} model_aligner --input_path colmap_localization/reconstruction/0 --output_path {output_dir}/reconstruction_georef --ref_images_path colmap_localization/reconstruction/georef.txt --alignment_max_error 1 --ref_is_gps 1 ')
